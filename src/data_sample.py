...
for language in languages:
    try:
        if os.stat(data_dir + language + "/generated.txt").st_size == 0:
            ...
            continue
        huge_dict = {}
        gen_file = open(data_dir + language + "/generated.txt")
            ...
            for word in line.split(" "):
                ...
                if word not in gen_dict:
                    ...
                    if gen_type_size % 100 == 0:
                        ...
                        type_y_for_type_x.append(good_type_size/gen_type_size)
                if gen_token_size % 100 == 0:
                    ...
                    type_y_for_token_x.append(good_type_size/gen_type_size)
